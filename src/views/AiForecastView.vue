...
import AiPurchaseAssignmentCreateModal from "../components/AiPurchaseAssignmentCreateModal.vue";
...
onMounted(async () => {
  ...
  successMessage.value = "";
  try {
    const availabilityRes = await getForecastAvailability(selectedSource.value);
